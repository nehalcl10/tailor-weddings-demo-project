...
Next.js 16 (App Router) frontend. Runs on port 3001 (slot 0 default; see docs/engineering/parallel-sandboxes.md). Uses Clerk auth and oRPC client for typed API calls.
